...
export const membersResources = [
    ...
    <Resource key="exchange-visits" name="exchange-visits" list={ExchangeVisitList} />,
    <Resource key="exchange-visit-attendees" name="exchange-visit-attendees" list={ExchangeVisitAttendeesList} />,
    ...
    <Resource key="dividend-declarations" name="dividend-declarations" list={DividendDeclarationList} />,
    <Resource key="dividends" name="dividends" list={MemberShareDividendList} />,
