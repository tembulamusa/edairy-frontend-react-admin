...
const PaymentTypeCreateToolbar = () => {
    ...
    return (
        <Toolbar sx={{ display: 'flex', justifyContent: 'space-between', backgroundColor: 'transparent', px: 0 }}>
            ...
            <Button
                ...
                onClick={() => redirect('/payment-types')}
            >
                Cancel
            </Button>
        </Toolbar>
                ...
                <CardContent sx={{ p: 4 }}>
                    <Grid container spacing={2} alignItems="center" justifyContent="space-between" mb={2}>
                        <Grid size={{ xs: 12, md: 12 }}>
                            <Typography variant="h5" fontWeight="bold">Create Payment Type</Typography>
                            <Typography variant="body2" color="text.secondary">Add a new payment type record.</Typography>
                        </Grid>
                    </Grid>
                    <Divider sx={{ mb: 4 }} />
                    <SimpleForm
                        toolbar={<PaymentTypeCreateToolbar />}
                        sx={{
