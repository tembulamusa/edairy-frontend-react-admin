                ...
                <CardContent sx={{ p: 4 }}>
                    <Grid container spacing={2} alignItems="center" justifyContent="space-between" mb={2}>
                        <Grid size={{ xs: 12, md: 12 }}>
                            <Typography variant="h5" fontWeight="bold">Edit Payment Type</Typography>
                            <Typography variant="body2" color="text.secondary">Modify payment type details.</Typography>
                        </Grid>
                    </Grid>
                    ...
                    <SimpleForm
                        toolbar={<PaymentTypeEditToolbar />}
                        sx={{
