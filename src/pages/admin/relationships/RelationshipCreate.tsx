...
const RelationshipCreateToolbar = () => {
    ...
    return (
        <Toolbar sx={{ display: 'flex', justifyContent: 'space-between', backgroundColor: 'transparent', px: 0 }}>
            ...
            <Button
                ...
                onClick={() => redirect('/relationships')}
            >
                Cancel
            </Button>
        </Toolbar>
                ...
                <CardContent sx={{ p: 4 }}>
                    <Grid container spacing={2} alignItems="center" justifyContent="space-between" mb={2}>
                        <Grid size={{ xs: 12, md: 12 }}>
                            <Typography variant="h5" fontWeight="bold">Create Relationship</Typography>
                            <Typography variant="body2" color="text.secondary">Add a new relationship record.</Typography>
                        </Grid>
                    </Grid>
                    <Divider sx={{ mb: 4 }} />
                    <SimpleForm
                        toolbar={<RelationshipCreateToolbar />}
                        sx={{
