                ...
                <CardContent sx={{ p: 4 }}>
                    <Grid container spacing={2} alignItems="center" justifyContent="space-between" mb={2}>
                        <Grid size={{ xs: 12, md: 12 }}>
                            <Typography variant="h5" fontWeight="bold">Edit Relationship</Typography>
                            <Typography variant="body2" color="text.secondary">Modify relationship details.</Typography>
                        </Grid>
                    </Grid>
                    ...
                    <SimpleForm
                        toolbar={<RelationshipEditToolbar />}
                        sx={{
