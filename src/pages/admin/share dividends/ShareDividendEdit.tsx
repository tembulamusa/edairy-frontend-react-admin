...
const ShareDividendEditToolbar = () => {
                ...
                <CardContent sx={{ p: 4 }}>
                    <Grid container spacing={2} alignItems="center" justifyContent="space-between" mb={2}>
                        <Grid size={{ xs: 12, md: 12 }}>
                            <Typography variant="h5" fontWeight="bold">Edit Share Dividend</Typography>
                            <Typography variant="body2" color="text.secondary">Modify share dividend details.</Typography>
                        </Grid>
                    </Grid>
                    ...
                    <SimpleForm
                        toolbar={<ShareDividendEditToolbar />}
                        sx={{
