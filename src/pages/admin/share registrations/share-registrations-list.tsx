...
export const ShareRegistrationList = () => {
    const can = useCan();
    const resource = useResourceContext() ?? "share-registrations";
                ...
                <CardContent>
                    <Grid container spacing={2} alignItems="center" justifyContent="space-between" mb={2}>
                        <Grid size={{ xs: 12, md: 6 }}>
                            <Typography variant="h5" fontWeight="bold">Share Registrations</Typography>
                            <Typography variant="body2" color="text.secondary">Manage all share registration records</Typography>
                        </Grid>
