...
export const SmsErrorCodeList = () => {
    const can = useCan();
    const resource = useResourceContext() ?? "sms-error-codes";
                ...
                <CardContent>
                    <Grid container spacing={2} alignItems="center" justifyContent="space-between" mb={2}>
                        <Grid size={{ xs: 12, md: 6 }}>
                            <Typography variant="h5" fontWeight="bold">Sms Error codes</Typography>
                            <Typography variant="body2" color="text.secondary">Manage all sms error code records</Typography>
                        </Grid>
