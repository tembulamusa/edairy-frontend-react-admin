...
export const SmsList = () => {
    const can = useCan();
    const resource = useResourceContext() ?? "sms";
                ...
                <CardContent>
                    <Grid container spacing={2} alignItems="center" justifyContent="space-between" mb={2}>
                        <Grid size={{ xs: 12, md: 6 }}>
                            <Typography variant="h5" fontWeight="bold">Sms</Typography>
                            <Typography variant="body2" color="text.secondary">Manage all sms records</Typography>
                        </Grid>
