...
export const CustomerBillingEdit = () => (
    <Edit title="Edit Customer Billing">
        <Box sx={{ p: { xs: 2, md: 3 } }}>
            <Box sx={{ mb: 3 }}>
            ...
            <Box display="flex" justifyContent="center">
                <Card sx={{ width: '100%', maxWidth: 800, boxShadow: '0 10px 15px -3px rgb(0 0 0 / 0.05), 0 4px 6px -4px rgb(0 0 0 / 0.05)', borderRadius: 3 }}>
                    ...
                    <SimpleForm>
                        ...
                        <NumberInput source="total_deliveries" label="Total Deliveries" validate={required()} fullWidth />
