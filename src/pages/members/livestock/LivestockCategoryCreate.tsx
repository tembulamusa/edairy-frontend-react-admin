...
const LivestockCategoryCreateToolbar = () => {
                ...
                <SaveButton
                    ...
                    mutationOptions={{
                        onSuccess: () => {
                            ...
                            redirect('create', 'livestock-categories');
                        },
                    }}
                />
            </Box>
...
export const LivestockCategoryCreate = () => (
    <Create
        title={false}
        sx={{
            "& .RaCreate-main": {
                ...
                <CardContent sx={{ p: 4 }}>
                    <Grid container spacing={2} alignItems="center" justifyContent="space-between" mb={2}>
                        <Grid size={{ xs: 12, md: 12 }}>
                            <Typography variant="h5" fontWeight="bold">Create Livestock Category</Typography>
                            <Typography variant="body2" color="text.secondary">Add a new livestock category record.</Typography>
                        </Grid>
                    </Grid>
                    <Divider sx={{ mb: 4 }} />
                    <SimpleForm
                        toolbar={<LivestockCategoryCreateToolbar />}
                        sx={{
