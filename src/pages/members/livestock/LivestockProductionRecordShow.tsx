...
export const LivestockProductionRecordShow = () => (
    <Show
        title={false}
        sx={{
            "& .RaShow-main": {
            ...
            <Card elevation={0} sx={{ borderRadius: 3, width: '100%', overflow: "hidden" }}>
                <CardContent sx={{ p: 4 }}>
                    <Grid container spacing={2} alignItems="center" justifyContent="space-between" mb={2}>
                        <Grid size={{ xs: 12, md: 12 }}>
                            ...
                            <Typography variant="body2" color="text.secondary">
                                View the details of the livestock production entry.
                            </Typography>
                        </Grid>
                    </Grid>
                    ...
                    <SimpleShowLayout>
                        ...
                        <TextField source="production_type" label="Production Type" />
                        <DateField source="production_date" label="Production Date" />
                        <NumberField source="quantity" label="Quantity" />
                        <TextField source="unit" label="Unit" />
                        <TextField source="quality_grade" label="Quality Grade" />
