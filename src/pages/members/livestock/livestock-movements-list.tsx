                ...
                <CardContent>
                    <List title={false} filters={LivestockMovementFilters} actions={false}>
                        <DataTable rowClick="show" sx={{ '& .RaDataTable-headerCell': { fontWeight: "bold", backgroundColor: "#f5f5f5" } }}>
                            ...
                            <DataTable.Col source="from_location" label="From Location" />
                            <DataTable.Col source="to_location" label="To Location" />
                            <DateField source="movement_date" label="Movement Date" />
                            <DataTable.Col source="movement_type" label="Movement Type" sx={{ textTransform: 'capitalize' }} />
                                ...
                                <Stack direction="row" spacing={1} alignItems="center">
                                    ...
                                    {canDelete && (
                                        <Tooltip title="Delete Record">
                                            <span><DeleteButton label={false} mutationMode="pessimistic" confirmTitle="⚠️ Confirm deletion" confirmContent="This will remove the movement record." sx={{ minWidth: 36 }} /></span>
                                        </Tooltip>
                                    )}
                                </Stack>
                            </DataTable.Col>
