...
const MemberShareCreateToolbar = () => {
        ...
        <Toolbar sx={{ display: 'flex', justifyContent: 'space-between', backgroundColor: 'transparent', px: 0 }}>
            <Box sx={{ display: 'flex', gap: 1 }}>
                ...
                <SaveButton
                    ...
                    mutationOptions={{
                        onSuccess: () => {
                            notify('Share account created successfully', { type: 'success' });
                            redirect('create', 'share-accounts');
                        },
                    }}
                />
            </Box>
            <Button
                ...
                onClick={() => redirect('/share-accounts')}
            >
                Cancel
            </Button>
        </Toolbar>
...
export const MemberShareCreate = () => (
    <Create
        title={false}
        sx={{
    ...
    >
        <Box sx={{ width: '100%', maxWidth: 1100 }}>
            ...
            <Card elevation={0} sx={{ borderRadius: 3, overflow: "hidden", width: '100%' }}>
                <CardContent sx={{ p: 4 }}>
                    <Typography variant="h5" fontWeight="bold">New Share Account</Typography>
                    <Typography variant="body2" color="text.secondary" sx={{ mb: 2 }}>
                        Open a new share account for a member.
                    </Typography>
                    <Divider sx={{ mb: 4 }} />
                    <SimpleForm
                        toolbar={<MemberShareCreateToolbar />}
                        sx={{
                    ...
                    >
                        <Grid container spacing={2} alignItems="flex-start">
                            ...
                            <Grid item xs={12} md={6}>
                                <NumberInput source="initial_units" label="Initial Share Units" defaultValue={0} fullWidth variant="outlined" />
                            </Grid>
                        </Grid>
                    </SimpleForm>
                </CardContent>
