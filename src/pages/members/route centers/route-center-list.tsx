...
const RouteCenterFilters = [
    <TextInput source="q" label="Search" alwaysOn />,
    <TextInput source="center" label="Center Name" />,
    <TextInput source="route_name" label="Route Name" />,
];

export const RouteCenterList = () => {
    const can = useCan();
    const resource = useResourceContext() ?? "route-centers";
                ...
                <CardContent>
                    ...
                    >
                        ...
                        >
                            ...
                            <DataTable.Col source="center" label="Center Name" />
