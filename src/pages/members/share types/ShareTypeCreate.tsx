    ...
    >
        <Box sx={{ width: '100%', maxWidth: 1100 }}>
            ...
            <Card elevation={0} sx={{ borderRadius: 3, overflow: "hidden", width: '100%' }}>
                <CardContent sx={{ p: 4 }}>
                    <Typography variant="h5" fontWeight="bold">New Share Type</Typography>
                    <Typography variant="body2" color="text.secondary" sx={{ mb: 2 }}>
                        Define a new classification for shares and their unit pricing.
                    </Typography>
                    <Divider sx={{ mb: 4 }} />
                    <SimpleForm
                        toolbar={<ShareTypeCreateToolbar />}
                        sx={{
                    ...
                    >
                        <Grid container spacing={2} alignItems="flex-start">
                            ...
                            <Grid item xs={12} md={6}>
                                <NumberInput source="unit_price" label="Price per Unit" validate={required()} fullWidth variant="outlined" />
                            </Grid>
                            <Grid item xs={12}>
