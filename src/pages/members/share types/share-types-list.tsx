import { List, DataTable, DateField, EditButton, DeleteButton, BooleanField, useResourceContext, CreateButton, ShowButton, TextInput } from 'react-admin';
...
export const ShareTypeList = () => {
    const can = useCan();
    const resource = useResourceContext() ?? "share-types";
                ...
                <CardContent>
                    ...
                    >
                        <Grid size={{ xs: 12, md: 6 }}>
                            ...
                            >
                                Manage all share type definitions
                            </Typography>
                        </Grid>
