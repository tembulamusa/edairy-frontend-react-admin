import { Edit, SimpleForm, TextInput, NumberInput, SelectInput, DateTimeInput, required, useGetList, ArrayInput, SimpleFormIterator } from 'react-admin';
...
export const PurchaseOrderEdit = () => {
    ...
    return (
        <Edit title="Edit Purchase Order" transform={transform}>
            <Box sx={{ p: { xs: 2, md: 3 } }}>
                <Box sx={{ mb: 3 }}>
