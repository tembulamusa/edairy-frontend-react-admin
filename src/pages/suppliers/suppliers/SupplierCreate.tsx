import { Create, TabbedForm, TextInput, SelectInput, NumberInput, required, useGetList, FormDataConsumer } from 'react-admin';
...
export const SupplierCreate = () => {
    ...
    return (
        <Create title="Create Supplier" transform={transform}>
            <Box sx={{ p: { xs: 2, md: 3 } }}>
                <Box sx={{ mb: 3 }}>
                    ...
                    <Typography variant="body2" color="text.secondary" sx={{ mb: 1 }}>
                        Fill in the details below to register a new supplier in the system.
                    </Typography>
                    <Box mt={1}>
                        <ListBreadcrumbs />
                    </Box>
